...
export function IconUpload({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconShare({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconBarChart({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconHeart({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconMessageCircle({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
