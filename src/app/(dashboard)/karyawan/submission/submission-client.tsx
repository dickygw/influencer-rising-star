            ...
            <div style={{ display: 'flex', gap: 'var(--spacing-md)' }} className="animate-fade-in">
              <button
                ...
                style={{
                  ...
                  padding: '0.875rem',
                  borderRadius: '12px',
                  background: verifyMethod === 'auto' ? 'rgba(13, 169, 77, 0.15)' : 'var(--bg-secondary)',
                  border: `1px solid ${verifyMethod === 'auto' ? 'var(--green-light)' : 'var(--border-default)'}`,
                  color: verifyMethod === 'auto' ? 'var(--green-light)' : 'var(--text-secondary)',
                  fontWeight: 700,
                  fontSize: '0.875rem',
                  cursor: 'pointer',
                  transition: 'all var(--transition-fast)'
              ...
              <button
                ...
                style={{
                  ...
                  padding: '0.875rem',
                  borderRadius: '12px',
                  background: verifyMethod === 'manual' ? 'rgba(13, 169, 77, 0.15)' : 'var(--bg-secondary)',
                  border: `1px solid ${verifyMethod === 'manual' ? 'var(--green-light)' : 'var(--border-default)'}`,
                  color: verifyMethod === 'manual' ? 'var(--green-light)' : 'var(--text-secondary)',
                  fontWeight: 700,
                  fontSize: '0.875rem',
                  cursor: 'pointer',
                  transition: 'all var(--transition-fast)'
